...
** Quelpa
#+BEGIN_SRC emacs-lisp
  ;;allows you to provide git location to use-package
...
#+END_SRC
*** GO Direx (create a map of your code file)
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
*** Go Eldoc(show details of keyword on cursor)
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
    (use-package go-guru
      :ensure t
  :init (go-guru-hl-identifier-mode))
#+END_SRC
*** Go test
#+BEGIN_SRC emacs-lisp
  (use-package gotest
